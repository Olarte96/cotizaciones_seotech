    ...
    <div class="col-sm">
        <form method="post" action="<?php echo BASE_URL ?>/?p=actualizar_cliente">
            ...
            <div class="form-group">
                ...
                <input value="<?php echo htmlentities($cliente->nit) ?>" autofocus name="nit"
                       autocomplete="off" required type="text" class="form-control" id="nit"
                       placeholder="Nit">
            </div>
            <div class="form-group">
                <label for="ciudad">Ciudad</label>
                <input value="<?php echo htmlentities($cliente->ciudad) ?>" autofocus name="ciudad"
                       autocomplete="off" required type="text" class="form-control" id="ciudad"
                       placeholder="Ciudad">
            </div>
