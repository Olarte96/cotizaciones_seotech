<?php if (SesionService::obtenerIdUsuarioLogueado() !== NULL) { ?>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="<?php echo BASE_URL ?>"><img src="img/logo3.png" width="180px" height="60px"></a>
        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav">
                ...
                <li class="nav-item <?php echo (isset($_GET["p"]) && $_GET["p"] === "editar_ajustes") ? 'active' : '' ?>">
                    <a class="nav-link" href="<?php echo BASE_URL ?>/?p=editar_ajustes">Notas</a>
                </li>
                <li class="nav-item">
