...
class Ajustes
{
    public static function guardar($remitente, $mensajeAgradecimiento, $mensajePie)
    {
        $bd = BD::obtener();
        ...
        mensajePie = ? 
        where idUsuario = ?");
        return $sentencia->execute([$remitente, $mensajeAgradecimiento, $mensajePie, SesionService::obtenerIdUsuarioLogueado()]);
    }
